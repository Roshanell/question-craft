                  ...
                  <Card.Body>
                    ...
                    <div className="d-flex justify-content-start">
                      <a href="https://github.com/TanyaPina" className="mr-3">
                        <Github size="2rem" style={{ marginRight: '0.5rem', color: '#05556d' }} />
                      </a>
        ...
        <Row>
          <Col xs={12}>
            <Card className="mb-3">
              <Row noGutters>
                <Col xs={4}>
                  <Image src="https://miro.medium.com/v2/resize:fit:1000/format:webp/1*Oxhs2VdlOI1z1javQI1s4w.jpeg" style={{ maxWidth: '100%', height: 'auto', width: '300px' }} roundedCircle className="p-3" />
                </Col>
                <Col xs={8}>
                  <Card.Body>
                    <Card.Title>Meet Rahma (she/her)</Card.Title>
                    <Card.Text>
                    Rahma is a San Francisco Bay Area native and undergraduate at UC Berkeley where she serves as Regents & Chancellors Scholar. Her initial introduction to coding was as a Research Apprentice, where she honed her analytical prowess in utilizing Python libraries for mixed-method data analysis. After an internship for an NGO in East Africa, she was inspired to build web application solutions tackling critical issues such as telemedicine care in rural Kenya. As a software engineer, Rahma is committed to building transformative products that inspire innovation and reach diverse communities worldwide.
                    </Card.Text>
                    <div className="d-flex justify-content-start">
                      <a href="https://github.com/rahmamahdi02" className="mr-3">
                        <Github size="2rem" style={{ marginRight: '0.5rem', color: '#05556d' }} />
                      </a>
