        ...
        <Row>
          <Col md={6} className="offset-md-3">
            <Card className="mb-3">
              <Row noGutters>
                <Col md={4}>
                  <Image src="https://miro.medium.com/v2/resize:fit:1000/format:webp/1*JNoIODyECscyVkkSwuVXzw.png" roundedCircle className="p-3" />
                </Col>
                <Col md={10}>
                  <Card.Body>
            ...
            <Card className="mb-3">
              <Row noGutters>
                <Col md={4}>
                  <Image src="https://miro.medium.com/v2/resize:fit:1000/format:webp/1*K4UH3KOsovJE7fzqdA23Fg.png" roundedCircle className="p-3" />
                </Col>
                <Col md={10}>
                  <Card.Body>
            ...
            <Card className="mb-3">
              <Row noGutters>
                <Col md={4}>
                  <Image src="https://miro.medium.com/v2/resize:fit:1000/format:webp/1*ZzUGWgV_iSVhWHHtQVPHSw.png" roundedCircle className="p-3" />
                </Col>
                <Col md={10}>
                  <Card.Body>
